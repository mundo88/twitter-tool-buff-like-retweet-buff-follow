...
class Like:
    ...
    def run_thread(self):
        ...
        return {
            'message':f'============================\nLike thành công \t{len(results)}\n============================\n'
        }
    def run(self,cookie):
        res = self.s.post(f'https://twitter.com/i/api/graphql/{Config.like_query_id}/FavoriteTweet',headers={
            'cookie':cookie,
        ...
        try:
            ...
            if (res_json.get('errors')) :
                ...
                print(f'=>log: {res_json['data']['favorite_tweet']}')
                return True
        except:
            return False